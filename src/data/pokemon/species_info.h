...
const struct SpeciesInfo gSpeciesInfo[] =
{
     ...
     [SPECIES_TAILLOW_MIDWEST] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Taillow_Midwest,
        ...
        .backPic = gMonBackPic_Taillow_Midwest,
        ...
        .palette = gMonPalette_Taillow_Midwest,
        .shinyPalette = gMonShinyPalette_Taillow_Midwest,
        .iconSprite = gMonIcon_Taillow_Midwest,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-3, 1, SHADOW_SIZE_S)
        FOOTPRINT(Taillow)
        OVERWORLD(
            sPicTable_Taillow_Midwest,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_Taillow_Midwest,
            gShinyOverworldPalette_Taillow_Midwest
        )
        .levelUpLearnset = sTaillowMidwestLevelUpLearnset,
        .teachableLearnset = sTaillowMidwestTeachableLearnset,
        .eggMoveLearnset = sTaillowMidwestTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_SWELLOW_MIDWEST}),
    },
    ...
    [SPECIES_FENNEKIN_MIDWEST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_RED,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Fennekin_Midwest,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_Fennekin_Midwest,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Fennekin_Midwest,
        .shinyPalette = gMonShinyPalette_Fennekin_Midwest,
        .iconSprite = gMonIcon_Fennekin_Midwest,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(0, 4, SHADOW_SIZE_S)
        FOOTPRINT(Fennekin)
        OVERWORLD(
            sPicTable_Fennekin_Midwest,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_Fennekin_Midwest,
            gShinyOverworldPalette_Fennekin_Midwest
        )
        .levelUpLearnset = sFennekinMidwestLevelUpLearnset,
        .teachableLearnset = sFennekinMidwestTeachableLearnset,
        .eggMoveLearnset = sFennekinMidwestEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_BRAIXEN_MIDWEST}),
    },
     ...
     [SPECIES_ROWLET_MIDWEST] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Rowlet_Midwest,
        ...
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        .backPic = gMonBackPic_Rowlet_Midwest,
        .backPicSize = MON_COORDS_SIZE(43, 36),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Rowlet_Midwest,
        .shinyPalette = gMonShinyPalette_Rowlet_Midwest,
        .iconSprite = gMonIcon_Rowlet_Midwest,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-1, 1, SHADOW_SIZE_S)
        FOOTPRINT(Rowlet)
        OVERWORLD(
            sPicTable_Rowlet_Midwest,
            SIZE_32x32,
            SHADOW_SIZE_M,
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_Rowlet_Midwest,
            gShinyOverworldPalette_Rowlet_Midwest
        )
        .levelUpLearnset = sRowletMidwestLevelUpLearnset,
        .teachableLearnset = sRowletMidwestTeachableLearnset,
        .eggMoveLearnset = sRowletMidwestEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_DARTRIX_MIDWEST}),
    },
