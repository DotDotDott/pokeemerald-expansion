...
const struct Tileset gTileset_PorytilesSec_Foresty =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_PorytilesSec_Foresty,
    .palettes = gTilesetPalettes_PorytilesSec_Foresty,
    .metatiles = gMetatiles_PorytilesSec_Foresty,
...
const struct Tileset gTileset_porytiles_sec_MyPC =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_porytiles_sec_MyPC,
    .palettes = gTilesetPalettes_porytiles_sec_MyPC,
    .metatiles = gMetatiles_porytiles_sec_MyPC,
    .metatileAttributes = gMetatileAttributes_porytiles_sec_MyPC,
    .callback = NULL,
};
