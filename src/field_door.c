...
static const u8 sDoorAnimTiles_MyPrimaryMyPCDoor[] = INCBIN_U8("graphics/door_anims/myPokeCenter.4bpp");
...
static const u8 sDoorAnimPalettes_MyPrimaryMyPCDoor[] = {1, 1, 1, 1, 1, 1, 1, 1};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_PorytilesPrimaryTest_MyPokeCenterDoor,        DOOR_SOUND_SLIDING, DOOR_SIZE_1x1, sDoorAnimTiles_MyPrimaryMyPCDoor, sDoorAnimPalettes_MyPrimaryMyPCDoor},
    {},
};
