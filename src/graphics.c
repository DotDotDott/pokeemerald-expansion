...
const u16 gMessageBox_Pal[] = INCBIN_U16("graphics/text_window/indy_message_box_pal.gbapal");
const u8 gMessageBox_Gfx[] = INCBIN_U8("graphics/text_window/indy_message_box.4bpp");
